    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Descriptions",
                columns: new[] { "DescriptionId", "Text" },
                values: new object[] { 1, "Algorithm calculates int id for url and uses as part of short url." });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Urls_OwnerUserId",
                table: "Urls",
                column: "OwnerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Urls_SourceUrl",
                table: "Urls",
                column: "SourceUrl",
                unique: true);
        }
